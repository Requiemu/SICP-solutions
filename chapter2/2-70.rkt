#lang racket
;根据字母及其权重生成haffman树，本次所实现的方法能够对并没有顺序排列的字母权重对生成。
...
(define rock-symbols '((a 2) (boom 1) (Get 2) (job 2) (na 16) (Sha 3) (yip 9) (Wah 1)))
...
(define rock-song-code 
        (encode rock-song
        rock-tree))

(display rock-song-code)
(newline)

(display (decode rock-song-code rock-tree))
(newline)

(display (length rock-song-code))
(newline)

(display (* (length rock-song) 3))
(newline)
