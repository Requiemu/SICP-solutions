...
;;;;the definition here doesn't support the type (define (f x) (... x ...)) 
;;;;modify the "definition-variable", "definition-value" to add the function.
...
;;normal type: (define a b), function type: (define (f x) (... x ...))
